...
autocmd bufreadpre,BufNew,BufRead,BufNewFile,BufReadPost *.py setlocal textwidth=80
autocmd bufreadpre,BufNew,BufRead *.h setlocal textwidth=80
autocmd bufreadpre,BufNew,BufRead *.c setlocal textwidth=80
autocmd bufreadpre,BufNew,BufRead *.cpp setlocal textwidth=80
autocmd bufreadpre,BufNew,BufRead *.hpp setlocal textwidth=80
